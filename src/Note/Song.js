...
// A class for the "song". My thought was that this could include all parameters
// that the user can change, which
...
class Song {
  constructor(key, tempo, diatonicProbability, synth) {
    ...
    // This is not yet implemented, but could be used as a probability for
    // generated notes to be within the key of the song.
